...
namespace VendégGridview
{
    ...
    public partial class Teszt2 : Form
    {
        ...
        private void feltoltVezerlotAdatbazisbolMindenAdattal()
        {
            ...
            mdi = a.kapcsolodas();
            mdi.open();
            csillagokDT = mdi.getToDataTable("SELECT id, kerdesszam, jovalasz, valasz FROM valaszok ");
        ...
        /// <summary>
        /// Vezérlőket beállítja szerkeszthetőre.
        /// </summary>
