        ...
        public void addTeamToF1(string teamName)
        {
            ...
            if (teamService.existTeamName(teamName))
                throw new ControllerException(
                    teamName + " nevű csapat már létezik."
             );
            ...
            catch (NameNotValidNameIsEmptyException exception1)
            {
                throw new ControllerException("A csapatnév üres");
            }
            catch (NameNotValidFirstLetterProblemException exception2)
            {
                throw new ControllerException(teamName + " csapat első betűje nem lehet kisbetű");

            }
            catch (NextToFirstLetterIsNotLowerException exception3)
            {
                throw new ControllerException(teamName + " csapat első betűje nem lehet kisbetű");
            }
